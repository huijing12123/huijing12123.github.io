...
const Box: React.FC<BoxProps> = ({ title, subtitle, content }) => (
    <div className={[styles._box, styles[`_box${title}`]].join(" ")}>
        ...
        <div className={styles._boxSvg}>
            <span>
                <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5164" width="100" height="100">
                    ...
                    <div className={styles._link}>
                        <a href='https://www.16personalities.com/profiles/68118e48fd0cf'>learn more
                            <span style={{ marginLeft: "5px" }}>
                                <svg  className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3182" width="15" height="15">
