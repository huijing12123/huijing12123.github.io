                                ...
                                >
                                    ...
                                    {isHovered && (
                                        <div className={styles.svgContainer} style={{ left: svgPosition.x, top: svgPosition.y }}>
                                            <svg className="icon" viewBox="0 0 1122 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1806" width="50" height="50">
                ...
                <div className={styles.popupOverlay}>
                    <div className={styles.popup}>
                        ...
                        <span className={styles.closeButton} onClick={() => setSelectedCat(null)}>
                            <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2267" width="50" height="50">
